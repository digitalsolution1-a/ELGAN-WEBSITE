    ...
    <section className="relative flex min-h-[92vh] items-center overflow-hidden">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 pt-28 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          ...
          >
            ELGAN Integrated Services delivers maritime security engineering, defence equipment
            supply, secure document production, and strategic advisory for governments, military,
