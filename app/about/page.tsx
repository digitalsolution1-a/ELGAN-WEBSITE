  ...
  return (
    <>
      <PageHero
        ...
        description="Elgan Integrated Limited is a Nigerian company specialising in security and defence engineering, maritime protection, and strategic consultancy. Headquartered in Apapa, Lagos — Nigeria’s principal maritime hub — we deliver high-quality, technically rigorous solutions that protect personnel, vessels, and critical national infrastructure."
      />
